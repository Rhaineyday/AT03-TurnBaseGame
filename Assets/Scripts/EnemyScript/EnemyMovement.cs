    ...
    void Update()
    {
        if (GameManager.instance.state == GameStates.EnemyTurn)
        {
            ...
            if (canAction)
            {
                ...
                else
                {
                    ...
                    if (detect.front == null || (detect.front != null && !detect.front.CompareTag("Player") && !detect.front.CompareTag("Tiles")))
                    {
                    ...
                    else if (detect.right == null || (detect.right != null && !detect.right.CompareTag("Player") && !detect.right.CompareTag("Tiles")))
                    {
                        if (actionsInTurn > 0)
                        {
                            TurnRight();
                    ...
                    else if (detect.left == null || (detect.left != null && !detect.left.CompareTag("Player") && !detect.left.CompareTag("Tiles")))
                    {
                        if (actionsInTurn > 0)
                        {
                            TurnLeft();
                    ...
                    else if (detect.back == null || (detect.back != null && !detect.back.CompareTag("Player") && !detect.back.CompareTag("Tiles")))
                    {
                        if (actionsInTurn > 1)
                        {
                            TurnAround();
        ...
        else
        {
            if (enemyTurnText.text != "Player Turn")
            {
                ...
                playerMovement.StartPlayerTurn();
